            ...
            <div className="relative backdrop-blur-sm bg-white/80 border border-slate-200/60 rounded-3xl shadow-2xl shadow-teal-500/10 overflow-hidden">
                ...
                <div className="p-8">
                    ...
                    <div className="text-center mb-8">
                        <button
                            onClick={startListening}
                            className={`group relative px-8 py-4 rounded-2xl font-semibold text-lg transition-all duration-300 transform hover:scale-105 focus:outline-none focus:ring-4 ${
                                isListening
